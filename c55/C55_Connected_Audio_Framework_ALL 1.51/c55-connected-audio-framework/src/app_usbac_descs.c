...
const Uint16 deviceDescriptor[DEVICE_DESCR_SZ] = 
{
    ...
    0x2000,         //bDeviceProtocol   //bMaxPacketSize0
    DEV_VID,        //idVendor
    DEV_PID,        //idProduct
    DEV_BCD,        //bcdDevice
...
/* End of Class-Specific AudioControl Interface Descriptor section */
    ...
    EP_NUM_REC,     /* bEndpointAddress=EP1-IN Direction, Address 1 */
...
#ifdef ENABLE_PLAYBACK_TWO_SAMPLE_RATES
    0x02,           /* bSamFreqType=2 Descrete sample */
    ...
    0x01,           /* bSamFreqType=Single (1) Descrete sample */
    ...
    EP_NUM_PLAY,    /* bEndpointAddress=EP2-OUT Direction, Address 2 */
    ...
    0x07,           /* bLength, in bytes */
    0x05,           /* bDescriptorType=ENDPOINT */
    EP_NUM_HID,     /* bEndpointAddress=EP3-IN Direction, Address 3 */
...
char    strDesc[4][20] = {
						    ...
						    0x0074, 0x0072, 0x0075, 0x006D, 0x0065, 0x006E, 0x0065, 0x0073},
