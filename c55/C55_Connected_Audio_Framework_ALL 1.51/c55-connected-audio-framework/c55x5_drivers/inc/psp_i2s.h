...
//#define CODEC_OUTPUT_FIFO_NUM_BUF   ( 16 )
#define CODEC_OUTPUT_FIFO_NUM_BUF   ( 8 )
...
#define CODEC_INPUT_BUFFER_SIZE     (10*RXBUFF_SZ_ADCSAMPS)  /* for smaller input frame size, e.g. 1 msec. */
//#define CODEC_INPUT_BUFFER_SIZE     (2*RXBUFF_SZ_ADCSAMPS) /* for larger input frame size, e.g. 10 msec. */
