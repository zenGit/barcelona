...
extern SEM_Obj SEM_RecAudioAlg;
...
/**
 *   \brief Call back function for DMA receive complete
 *
 ...
 *
 */
void I2S_DmaRxCallBack(PSP_DMATransferStatus    dmaStatus,
                       void    *dataCallback)
{
#ifdef ENABLE_RECORD
