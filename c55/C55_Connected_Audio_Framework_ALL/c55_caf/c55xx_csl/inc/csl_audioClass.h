...
#define CSL_AC_VOLUME_CTRL_BUF_LEN                            (2)
/** Audio Class Feature Unit Mute Control request ID                         */
#define CSL_AC_MUTE_CTRL_BUF_LEN                              (2)
/** Audio Class Feature Unit Mute Control request ID                         */
...
#define USB_AC_FEATURE_UNIT_LEFT_RIGHT_VOLUME                 (0xFF)
...
extern Uint16 numRecSamps;

extern Bool sample_rate_change; // playback sample rate change flag
