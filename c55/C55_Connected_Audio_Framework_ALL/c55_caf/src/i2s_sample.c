...
Uint16 ping_i2sTxLeftBuf[I2S_TXBUFF_SZ+4];
#pragma DATA_ALIGN(ping_i2sTxRightBuf, 4);
Uint16 ping_i2sTxRightBuf[I2S_TXBUFF_SZ+4];
#pragma DATA_ALIGN(pong_i2sTxLeftBuf, 4);
Uint16 pong_i2sTxLeftBuf[I2S_TXBUFF_SZ+4];
#pragma DATA_ALIGN(pong_i2sTxRightBuf, 4);
Uint16 pong_i2sTxRightBuf[I2S_TXBUFF_SZ+4];

#else /* ENABLE_STEREO_PLAYBACK */
#pragma DATA_ALIGN(i2sTxLeftBuf, 4);
Uint16 i2sTxLeftBuf[I2S_TXBUFF_SZ];
#pragma DATA_ALIGN(i2sTxRightBuf, 4);
Uint16 i2sTxRightBuf[I2S_TXBUFF_SZ];
...
#if defined(SAMPLE_RATE_TX_48kHz) && defined(ENABLE_PLAYBACK_TWO_SAMPLE_RATES)
//#ifdef ENABLE_PLAYBACK_TWO_SAMPLE_RATES /* note 48 kHz playback required for two playback sample rates */
...
#else /* defined(SAMPLE_RATE_TX_48kHz) && defined(ENABLE_PLAYBACK_TWO_SAMPLE_RATES) */
...
#endif /*  defined(SAMPLE_RATE_TX_48kHz) && defined(ENABLE_PLAYBACK_TWO_SAMPLE_RATES) */
